...
namespace Claw
{
    ...
    public class clawMain : Game
    {
        ...
        protected override void Initialize()
        {
            ...
            using (var stream = TitleContainer.OpenStream("score.txt"))
            {
       ...
       while (inter); //as long as it is intersecting
        ...
        protected override void Draw(GameTime gameTime)
        {
           ...
           {
               DrawTitleScreen();
               spriteBatch.Draw(staticHit, new Rectangle(110, 250, 270, 75), Color.Black);
           ...
           else if(gameOver)
           {
               if (expSys.totalExperience > highScore)
               {
                   ...
                   using (System.IO.StreamWriter file = new System.IO.StreamWriter("score.txt"))
                   {
